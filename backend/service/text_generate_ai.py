                ...
                if os.path.exists(content_file):
                    with open(content_file, 'r', encoding='utf-8') as f:
                        ...
                        response = client.models.generate_content(
                            ...
                            contents=f"""Viết lại đoạn văn sau thành 10 đoạn theo nhiều cách khác nhau, vẫn giữ nguyên nội dung chủ đề và không chia nhỏ. Hãy đánh số từ 1-10 cho mỗi đoạn. Ví dụ:
                                1. [đoạn văn 1]
                                2. [đoạn văn 2]
                                3. [đoạn văn 3]
                                ...
